            ...
            <template v-for="(item, index) in items">
              <bs-list-tile :key="item.title" navigable>
                ...
                <bs-list-tile-content>
                  <bs-list-tile-title v-html="item.title" class="text-black" />
        ...
        <bs-card shadow>
          <bs-list-view color="unique-color-dark">
            <bs-subheader>
              ...
              <bs-menu
                ...
                <template #content>
                  <bs-list-view color="default-color-dark">
            ...
            <template v-for="(item, index) in chats1">
              <bs-list-tile :key="item.title" navigable>
                <bs-list-tile-leading :img-src="item.avatar" circle />
                <bs-list-tile-content>
                  <bs-list-tile-title v-html="item.title" />
                </bs-list-tile-content>
                <bs-list-tile-action>
                  <font-awesome-icon
                    icon="comment-alt"
                    size="lg"
                    :class="{'text-teal':item.active}" />
                </bs-list-tile-action>
              </bs-list-tile>
              <bs-divider
                v-if="index + 1 < chats1.length"
                left-indent="80"
                :key="item.title + index" />
            </template>
          </bs-list-view>
          <bs-list-view color="unique-color-dark">
            ...
            <template v-for="(item, index) in chats2">
              ...
              <bs-divider v-if="index + 1 < chats2.length" :key="item.title + index" />
            </template>
          </bs-list-view>
        </bs-card>
      </div>
...
export default {
    ...
    data: () => ({
        ...
        chats1: [
            {active: true, title: 'Jason Oner', avatar: 'img/1.jpg'},
            {active: true, title: 'Ranee Carlson', avatar: 'img/2.jpg'},
            {title: 'Cindy Baker', avatar: 'img/3.jpg'},
            {title: 'Ali Connors', avatar: 'img/4.jpg'}
        ],
        chats2: [
            {title: 'Travis Howard', avatar: 'img/5.jpg'}
        ],
    }),
}
</script>
